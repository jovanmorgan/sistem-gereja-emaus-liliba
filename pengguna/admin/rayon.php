...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4" id>
            ...
            $query = "SELECT * FROM rayon WHERE id_rayon LIKE ? OR nama_rayon LIKE ? LIMIT ?, ?";
            ...
            $total_query = "SELECT COUNT(*) as total FROM rayon WHERE id_rayon LIKE ? OR nama_rayon LIKE ?";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                              <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <span
                                                            class="text-secondary text-xs font-weight-bold">Rayon <?php echo $row['nama_rayon']; ?></span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <button class="btn btn-warning btn-sm"
                                                            onclick="openEditModal('<?php echo $row['id_rayon']; ?>','<?php echo $row['nama_rayon']; ?>')">Edit</button>
                                                        <button class="btn btn-danger btn-sm"
                                                            onclick="hapus('<?php echo $row['id_rayon']; ?>')">Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php $nomor++;
                                            endwhile; ?>
                    ...
                    <div class="modal-body">
                        <form id="tambahForm" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" id="nama_rayon" name="nama_rayon" class="form-control" required>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="nama_rayon" class="form-label">Nama Rayon</label>
                                <input type="text" id="edit_nama_rayon" name="nama_rayon" class="form-control" required>
                            </div>
        ...
        <script>
            function openEditModal(id_rayon, nama_rayon) {
                let editModal = new bootstrap.Modal(document.getElementById('editModal'));
                document.getElementById('edit_id').value = id_rayon;

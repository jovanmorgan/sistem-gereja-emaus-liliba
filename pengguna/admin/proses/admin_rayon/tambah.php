...
// Cek apakah username sudah ada di database
$check_query_admin_rayon = "SELECT * FROM admin_rayon WHERE id_rayon = '$id_rayon'";
$result_admin_rayon = mysqli_query($koneksi, $check_query_admin_rayon);
if (mysqli_num_rows($result_admin_rayon) > 0) {
...
$query = "INSERT INTO admin_rayon (nama, id_rayon, username, password)
        VALUES ('$nama', '$id_rayon', '$username', '$password')";

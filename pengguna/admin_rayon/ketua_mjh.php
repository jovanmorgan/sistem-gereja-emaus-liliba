...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4" id>
            ...
            <?php
            // Ambil data ketua_mjh dari database
            ...
            // Query untuk mendapatkan data ketua_mjh dengan pencarian dan pagination
            $query = "SELECT * FROM ketua_mjh WHERE id_ketua_mjh LIKE ? OR nama LIKE ? OR username LIKE ? OR password LIKE ? LIMIT ?, ?";
            ...
            $total_query = "SELECT COUNT(*) as total FROM ketua_mjh WHERE id_ketua_mjh LIKE ? OR nama LIKE ? OR username LIKE ? OR password LIKE ?";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <button class="btn btn-warning btn-sm"
                                                            onclick="openEditModal('<?php echo $row['id_ketua_mjh']; ?>','<?php echo $row['nama']; ?>','<?php echo $row['username']; ?>','<?php echo $row['password']; ?>')">Edit</button>
                                                        <button class="btn btn-danger btn-sm"
                                                            onclick="hapus('<?php echo $row['id_ketua_mjh']; ?>')">Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" enctype="multipart/form-data">
                            <input type="hidden" id="id_ketua_mjh" name="id_ketua_mjh">
        ...
        <script>
            function openEditModal(id_ketua_mjh, nama, username, password) {
                let editModal = new bootstrap.Modal(document.getElementById('editModal'));
                document.getElementById('id_ketua_mjh').value = id_ketua_mjh;

            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="edit_gereja_asal" name="gereja_asal" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="edit_gereja_tujuan" class="form-label">Gereja Tujuan</label>
                        <input type="text" id="edit_gereja_tujuan" name="gereja_tujuan" class="form-control" required>
                    </div>
                    <!-- Select Status Sidi -->
                    <div class="mb-3">

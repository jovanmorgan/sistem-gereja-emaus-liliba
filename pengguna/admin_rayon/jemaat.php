...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4" id>
            ...
            $id_admin_rayon = $_SESSION['id_admin_rayon']; // ID admin yang login

            // Cari id_rayon dari admin_rayon berdasarkan id_admin_rayon
            $query_rayon = "
    SELECT id_rayon 
    FROM admin_rayon 
    WHERE id_admin_rayon = ?
";
            $stmt_rayon = $koneksi->prepare($query_rayon);
            $stmt_rayon->bind_param("i", $id_admin_rayon);
            $stmt_rayon->execute();
            $result_rayon = $stmt_rayon->get_result();
            $row_rayon = $result_rayon->fetch_assoc();
            $id_rayon = $row_rayon['id_rayon'];
            ...
            // Query untuk mengambil data jemaat berdasarkan id_rayon
            $query = "
    SELECT 
        jemaat.*, 
        rayon.nama_rayon, 
    ...
    LIMIT ?, ?";
            ...
            $search_param = '%' . $search . '%';
            $stmt->bind_param("issssii", $id_rayon, $search_param, $search_param, $search_param, $search_param, $offset, $limit);
            $stmt->execute();
            $result = $stmt->get_result();

            // Hitung total halaman berdasarkan id_rayon
            $total_query = "
    ...
    WHERE 
        ...
        jemaat.tempat_lahir LIKE ?)";
            ...
            $stmt_total->bind_param("issss", $id_rayon, $search_param, $search_param, $search_param, $search_param);
            $stmt_total->execute();
                                    ...
                                    <thead>
                                        <tr>
                                            <th
                                                ...
                                                <?php echo $id_admin_rayon; ?> Nomor</th>
                                            <th
                                                class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">
                                                Nama Rayon</th>
                                            <th
                        ...
                        <form id="tambahForm" method="POST" action="proses/jemaat/tambah.php"
                            ...
                            <div class="mb-3">
                                ...
                                <select id="id_rayon" name="id_rayon" class="form-control" required>
                                    ...
                                    $query_rayon = "SELECT id_rayon FROM admin_rayon WHERE id_admin_rayon = ?";
                                    $stmt_rayon = $koneksi->prepare($query_rayon);
                                    $stmt_rayon->bind_param("i", $id_admin_rayon);
                                    $stmt_rayon->execute();
                                    $result_rayon = $stmt_rayon->get_result();
                                    ...
                                    $query_rayon = "SELECT id_rayon, nama_rayon FROM rayon WHERE id_rayon = '$id_rayon'";
                            ...
                            <div class="mb-3">
                                ...
                                <select id="id_kk" name="id_kk" class="form-control" required>
                                    ...
                                    $query_kk = "SELECT id_kk, no_kk, nama_kepala_keluarga FROM kk WHERE id_rayon = '$id_rayon'";
                                    $result_kk = $koneksi->query($query_kk);
                                    while ($row_kk = $result_kk->fetch_assoc()) {
                                        echo "<option value='" . $row_kk['id_kk'] . "'>" . $row_kk['nama_kepala_keluarga'] . " (" . $row_kk['no_kk'] . ")</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="status_dalam_rumah" name="status_dalam_rumah" class="form-control">
                                    <option value="">Pilih Status dalam Rumah</option>
                                    <option value="Kepala Keluarga">Kepala Keluarga</option>
                                    <option value="Istri">Istri</option>
                                    <option value="Anak Kandung">Anak Kandung</option>
                                    <option value="Cucu">Cucu</option>
                                    <option value="Anak Tinggal">Anak Tinggal</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="penghasilan" name="penghasilan" class="form-control">
                                    ...
                                    <option value="1.500.000 - 2.500.00">1.500.000 - 2.500.00</option>
                                    <option value="2.500.000 - 4.000.000">2.500.000 - 4.000.000</option>
                                    <option value="Dan Seterusnya">Dst</option>
                                </select>
                            </div>
                            ...
                            <!-- Bagian ini akan ditampilkan hanya jika Status Babtis 'Sudah' -->
                            <div id="babtisDetails" style="display: none;">
                                <h5 class="modal-title text-center">Detail Babtis</h5>
                                <hr style="border: 2px solid aquamarine">
                                <div class="mb-3">
                                    <label for="nama_saksi" class="form-label">Nama Saksi</label>
                                    <input type="text" id="nama_saksi" name="nama_saksi" class="form-control"
                                        style="border: aquamarine 2px solid">
                                </div>
                                <div class="mb-3">
                                    <label for="pelayanan" class="form-label">Pelayanan</label>
                                    <input type="text" id="pelayanan" name="pelayanan" class="form-control"
                                        style="border: aquamarine 2px solid">
                                </div>
                                <div class="mb-3">
                                    <label for="tanggal_babtis" class="form-label">Tanggal Babtis</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="edit_pendidikan_terakhir" name="pendidikan_terakhir" class="form-control">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="pekerjaan" name="pekerjaan" class="form-control">
                                    ...
                                    <option value="bidan">Didan</option>
                                    <option value="perawat">Perawat</option>
                                    <option value="apoteker">Apoteker</option>
                                    <option value="psikolog / psikiater">Psikolog / Psikiater</option>
                                    <option value="penyiar">Penyiar</option>
                                    <option value="buruh harian lepas">Buruh Harian Lepas</option>
                                    <option value="ojek mandiri">Ojek Mandiri</option>
                                    ...
                                    <option value="Tukang las besi">Tukang Las Besi</option>
                                    ...
                                    <option value="Bupati">Walikota</option>
                            ...
                            <div class="mb-3">
                                <label for="status_marital" class="form-label">Status Marital</label>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="status_babtis" name="status_babtis" class="form-control" required>
                            ...
                            <div id="sidisDetails" style="display: none;">
                                <h5 class="modal-title text-center">Detail Sidi</h5>
                                <hr style="border: 2px solid #ffeb55">
                                <div class="mb-3">
                                    <label for="gereja" class="form-label">Nama Gereja</label>
                                    <input type="text" id="gereja" name="gereja" class="form-control"
                                        style="border: #ffeb55 2px solid">
                                </div>
                                <div class="mb-3">
                                    <label for="pelayanan" class="form-label">Pelayanan</label>
                                    <input type="text" id="pelayanan" name="pelayanan" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="tanggal_sidi" name="tanggal_sidi" class="form-control"
                                        style="border: #ffeb55 2px solid">
                                </div>
                                <div class="mb-3">
                                    <label for="tempat" class="form-label">Tempat</label>
                            ...
                            <div id="nikasDetails" style="display: none;">
                                <h5 class="modal-title text-center">Detail Nikah</h5>
                                <hr style="border: 2px solid #6bd6fd">
                                <div class="mb-3">
                                    <label for="tempat_nikah" class="form-label">Tempat Nikah</label>
                                    <input type="text" id="tempat_nikah" name="tempat_nikah" class="form-control"
                                        style="border: #6bd6fd 2px solid">
                                </div>
                                <div class="mb-3">
                                    <label for="pelayanan" class="form-label">Pelayanan</label>
                                    <input type="text" id="pelayanan" name="pelayanan" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="saksi_nikah" name="saksi_nikah" class="form-control"
                                        style="border: #6bd6fd 2px solid">
                                </div>
                                <hr style="border: 2px solid #6bd6fd">
                            </div>
        ...
        <!-- JavaScript untuk menampilkan atau menyembunyikan input babtis -->
        <script>
        document.getElementById('status_babtis').addEventListener('change', function() {
            var babtisDetails = document.getElementById('babtisDetails');

            if (this.value === 'Sudah') {
                // Tampilkan detail babtis
                babtisDetails.style.display = 'block';

            } else {
                // Sembunyikan detail babtis
                babtisDetails.style.display = 'none';
            }
        });
        document.getElementById('status_sidi').addEventListener('change', function() {
            var babtisDetails = document.getElementById('sidisDetails');
        ...
        document.getElementById('status_nikah').addEventListener('change', function() {
            var babtisDetails = document.getElementById('nikasDetails');
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="edit_id_rayon" name="id_rayon">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" id="edit_nik" name="nik" class="form-control" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="edit_status_dalam_rumah" name="status_dalam_rumah" class="form-control">
                                    <option value="">Pilih Status dalam Rumah</option>
                                    <option value="Kepala Keluarga">Kepala Keluarga</option>
                                    <option value="Istri">Istri</option>
                                    <option value="Anak Kandung">Anak Kandung</option>
                            ...
                            <div class="mb-3">
                                <label for="edit_status_marital" class="form-label">Status Marital</label>
                                <select id="edit_status_marital" name="status_marital" class="form-control" required>
                                    <option value="">Pilih Status Marital</option>
                                    <option value="lengkap">Lengkap</option>
                                    <option value="janda">Janda</option>
                                    <option value="duda">Duda</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="edit_pendidikan_terakhir" name="pendidikan_terakhir" class="form-control"
                                    required>
                                    <option value="pendidikan_terakhir">Pilih Pendidikan Terakhir</option>
                                    <option value="Belum Sekolah">Belum Sekolah</option>
                                    <option value="Tk">TK</option>
                                    <option value="Sd Sederajat">SD / Sederajat</option>
                                    <option value="Smp Sederajat">SMP / Sederajat</option>
                            ...
                            <div class="mb-3">
                                <label for="penghasilan" class="form-label">Penghasilan</label>
                                <select id="edit_penghasilan" name="penghasilan" class="form-control" required>
                                    <option value="">Pilih Penghasilan</option>
                                    <option value="Tidak ada Penghasilan">Tidak Ada Penghasilan</option>
                                    <option value="500.000 - 1.500.000">500.000 - 1.500.000</option>
                                    <option value="1.500.000 - 2.500.00">1.500.000 - 2.500.00</option>
        ...
        function openEditModal(id_jemaat, id_rayon, id_kk, nik, nama, jk, tempat_lahir, tanggal_lahir,
            status_dalam_rumah, gol_darah, suku, status_tempat_rumah, pendidikan_terakhir, pekerjaan, penghasilan,
            status_marital, status_babtis, status_sidi, status_nikah, keper_setaan, jenis_bantuan_sosial,
            jenis_diakonia, keterangan) {

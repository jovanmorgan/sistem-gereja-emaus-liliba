                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="openEditModal('<?php echo $row['id_sidi']; ?>','<?php echo $row['id_jemaat']; ?>', '<?php echo $row['gereja']; ?>', '<?php echo $row['pelayanan']; ?>', '<?php echo $row['tanggal_sidi']; ?>', '<?php echo $row['tempat']; ?>')">Edit</button>

                                                <button class="btn btn-danger btn-sm"
                                                    onclick="hapus('<?php echo $row['id_sidi']; ?>')">Hapus</button>
                                            </td>
                                        </tr>
                                        <?php $nomor++;
                                            endwhile; ?>

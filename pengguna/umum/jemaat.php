                        ...
                        <div class="card shadow">
                            <div class="card-body text-center">
                                <div class="card-header pb-0">
                                    <h3 class="text-center">Majelis Jemaat</h3>
                                </div>
                                <div class="garis"></div>
                                <style>
                                .garis {
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="align-middle text-center">Naomi Bere-besi</td>
                                            <td class="align-middle text-center">Rayon 1</td>
                                            <td class="align-middle text-center">Dken</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>

...
$select_query = "SELECT fp FROM pengelola WHERE id_pengelola = '$id_pengelola'";
...
// Update nama gambar di tabel pengelola berdasarkan id_pengelola
$update_query = "UPDATE pengelola SET fp = '$filename' WHERE id_pengelola = '$id_pengelola'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel pengelola

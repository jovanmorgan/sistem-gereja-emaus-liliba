...
$select_query = "SELECT fp FROM ketua_mjh WHERE id_ketua_mjh = '$id_ketua_mjh'";
...
// Update nama gambar di tabel ketua_mjh berdasarkan id_ketua_mjh
$update_query = "UPDATE ketua_mjh SET fp = '$filename' WHERE id_ketua_mjh = '$id_ketua_mjh'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel ketua_mjh

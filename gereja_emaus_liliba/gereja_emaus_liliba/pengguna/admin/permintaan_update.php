                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="openEditModal('<?php echo $row['id_permintaan_update']; ?>','<?php echo $row['pesan']; ?>','<?php echo $row['tanggal']; ?>')">Edit</button>
                                                <button class="btn btn-danger btn-sm"
                                                    onclick="hapus('<?php echo $row['id_permintaan_update']; ?>')">Hapus</button>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                    </tbody>

...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4" id>
            ...
            <?php
            // Ambil data pengelola dari database
            ...
            // Query untuk mendapatkan data pengelola dengan pencarian dan pagination
            $query = "SELECT * FROM pengelola WHERE id_pengelola LIKE ? OR nama LIKE ? OR username LIKE ? OR password LIKE ? LIMIT ?, ?";
            ...
            $total_query = "SELECT COUNT(*) as total FROM pengelola WHERE id_pengelola LIKE ? OR nama LIKE ? OR username LIKE ? OR password LIKE ?";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center">
                                                        <button class="btn btn-warning btn-sm"
                                                            onclick="openEditModal('<?php echo $row['id_pengelola']; ?>','<?php echo $row['nama']; ?>','<?php echo $row['username']; ?>','<?php echo $row['password']; ?>')">Edit</button>
                                                        <button class="btn btn-danger btn-sm"
                                                            onclick="hapus('<?php echo $row['id_pengelola']; ?>')">Hapus</button>
                                                    </td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
        ...
        <script>
            function openEditModal(id_pengelola, nama, username, password) {

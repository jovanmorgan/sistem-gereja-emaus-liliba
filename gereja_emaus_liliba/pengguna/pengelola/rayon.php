...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4" id>
            ...
            // Query untuk mendapatkan data rayon dengan pencarian dan pagination
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center"><a class="btn btn-danger btn-sm" href="jemaat/<?php echo $row['id_jemaat']; ?>" >Details</a></td>
                                        </tr>
                                        <?php endwhile; ?>
                                    </tbody>
                                </table>

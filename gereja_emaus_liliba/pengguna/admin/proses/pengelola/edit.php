...
// Cek apakah username sudah ada di database
$check_query_pengelola = "SELECT * FROM pengelola WHERE username = '$username' AND id_pengelola != '$id_pengelola'";
...
// Buat query SQL untuk mengedit data pengelola yang sudah ada berdasarkan id_pengelola
$query = "UPDATE pengelola 
            SET nama = '$nama', 
                username = '$username',
                password = '$password'

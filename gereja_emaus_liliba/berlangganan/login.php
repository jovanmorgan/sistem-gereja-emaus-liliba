...
<head>
    ...
    <link rel="shortcut icon" href="../assets/img/sma4/logo2.jpg" type="" />
                            ...
                            Swal.fire({
                                ...
                                switch (responseArray[2].trim()) {
                                    case "admin":
                                        ...
                                        break;
                                    case "admin_rayon":
                                        window.location.href = "../pengguna/admin_rayon/";
                                        break;
                                    case "pengelola":
                                        window.location.href = "../pengguna/pengelola/";
                                        break;
                                    case "ketua_mjh":
                                        window.location.href = "../pengguna/ketua_mjh/";
                                        break;
                                    default:
